...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function ValidateModuleList(source, args) {
            var chkListTargetAudience= document.getElementById ('<%= CheckBoxList2.ClientID %>');
            var chkListinputs = chkListTargetAudience.getElementsByTagName("input");
    ...
    <style>
        ...
        #ContentPlaceHolder1_btnBack, #ContentPlaceHolder1_btnGoGo {
            width: 140px;
        }
    </style>
</asp:Content>
    ...
    <form runat="server">  
        ...
        <div class="row">
            <div class="col-12">
                ...
                <asp:Button ID="btnGoGo" class="btn btn-primary float-right" runat="server" Text="Create" OnClick="ButtonConfirm_Click"/>
            </div>
        </div>
        ...
        <div class="row">
                ...
                <div class="form-group">
                    &nbsp;
                        ...
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" ValidationExpression='(.*?)\.(jpg|jpeg|png|gif|avi|flv|wmv|mp4|mov|JPG|JPEG|PNG|GIF|AVI|FLV|WMV|MOV|MP4)$'
                            ...
                            Display="Dynamic" />
                        <asp:RequiredFieldValidator ID="rfvImg" runat="server" ControlToValidate="FileUpload1" Display="Dynamic" ErrorMessage="Please upload an image or video" ForeColor="Red"></asp:RequiredFieldValidator>
            ...
            <div class="col-12 col-md-6" id="divCompany" runat="server" visible="false">
                <div class="form-group">
                <label>Company: </label>
                <label style="color: red">*</label>
                <asp:DropDownList class="form-control" ID="DropDownListCompany" runat="server" visible="false" ></asp:DropDownList>
                <asp:RequiredFieldValidator ID="rfvCompany" runat="server" ControlToValidate="DropDownListCompany" Display="Dynamic" InitialValue="0" ErrorMessage="Please select advertisement company" ForeColor="Red"></asp:RequiredFieldValidator>
                <br />
        ...
        <div class="row">
            <div class="col-12 col-md-6">
                <div class="form-group">
                    ...
                    <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToValidate="startDateTB" ErrorMessage="Invalid start date (Must start later than today)" Operator="GreaterThan" Type="Date" ForeColor="Red" style="position: absolute"></asp:CompareValidator>
        ...
        <div class="row">
                        ...
                        <ContentTemplate>
                            <p class="input-group">
                                ...
                                <span class="input-group-btn">
                                    <asp:LinkButton runat="server" class="btn btn-default" ID="CategoryButton"  Text="<i class='fa fa-caret-square-o-down'></i>" OnClick="CategoryButton_Click" causesValidation="false"/>
                                </span>
                            </p>
                            <asp:RequiredFieldValidator ID="rfvCategory" runat="server" ControlToValidate="adCategoryTB" Display="Dynamic" ErrorMessage="Please select at least one advertisement category" ForeColor="Red"></asp:RequiredFieldValidator>
                            <ajaxToolkit:PopupControlExtender ID="PopupControlExtender1" runat="server"
                                Enabled="True" ExtenderControlID="" TargetControlID="adCategoryTB"
                                PopupControlID="Panel1" OffsetY="22">
                            </ajaxToolkit:PopupControlExtender>
                            <asp:Panel ID="Panel1" Class="form-control" runat="server" Height="116px" Width="550px"
                                BorderStyle="Solid" BorderColor="#435058" BorderWidth="1px" Direction="LeftToRight"
                                ScrollBars="Auto" BackColor="whitesmoke" Style="margin-top: 10px;">
            ...
            <div class="col-12 col-md-6">
                <div class="form-group">
                    ...
                    <asp:RequiredFieldValidator ID="rfvBillboardDisplay" runat="server" ControlToValidate="billboardDisplayTB" Display="Dynamic" ErrorMessage="Please select at least one billboard location" ForeColor="Red"></asp:RequiredFieldValidator>
                    <br /><br />
                    </ContentTemplate>
                    <Triggers>
                        ...
                        <div class="modal-dialog modal-lg">
                            ...
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h4 class="modal-title" style="font-size: xx-large;">Billboards</h4>
                        ...
                        <Triggers>
                            <asp:AsyncPostBackTrigger ControlID="btnRun" EventName="Click" />
                                ...
                                <div class="modal-footer">
                                    <asp:Button runat="server" class="btn btn-default" ID="BillboardSearch" Style="height: 34px;" Text="Confirm" OnClick="BillboardSearch_Click" autopostback="true" causesValidation="false" />
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row">
            <div class="col-12 col-md-6">
                <div class="form-group">
                    ...
                    <label style="color: red">*</label>
                    <asp:CheckBoxList ID="CheckBoxList2" runat="server" Font-Size="small" Font-Bold="false" Height="92px" RepeatDirection="Horizontal"  RepeatColumns="4" >
                    ...
                    <asp:CustomValidator runat="server" ID="cvmodulelist" ClientValidationFunction="ValidateModuleList" ErrorMessage="Please select at least one target audience" ForeColor="Red"></asp:CustomValidator>
                </div>
            </div>
        </div>
            ...
            <div class="col-12">
                <div class="form-group">
                    ...
                    <asp:CheckBox ID="CheckBox1" runat="server" />
                        Please agree with the <a data-toggle="modal" data-target="#myModal" style="cursor:pointer; color: #4c4cff;">terms and conditions</a>
                    </p>
                    <asp:CustomValidator ID="cvTermsAndConditions" runat="server" ClientValidationFunction="ValidateCheckBox" ErrorMessage="Please agree to the T&C to proceed" ForeColor="Red"></asp:CustomValidator><br />
                    <!-- Modal -->
                    <div class="modal" id="myModal" role="dialog">
                        <div class="modal-dialog modal-lg">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <!-- <p>
                                        Welcome to our Targeted Marketing Display. These are the <u>terms and conditions</u> for use of our Targeted Marketing Display system.
                                    </p> -->
                                    <br /><br />
                                    <p style="text-align: left">1. As a condition of use, you promise not to use the services for any purpose that is unlawful.
                                    </p>
                                    <br /><br />
                                    <p style="text-align: left">2. The client acknowledges that the content of the advertisement is subject to copyright, and accordingly, the client shall ensure that the advertisement is used solely for the client's reference purposes and may not be copied, reproduced, rebroadcast or commercially exploited in all or any part.
                                    </p>
                                    <br /><br />
                                    <p style="text-align: left">3. You cannot terminate your contract before the end date.
                                    </p>
                                </div>
                                <div class="modal-footer">
