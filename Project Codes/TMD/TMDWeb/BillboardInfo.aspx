...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <form runat="server">       
        <div class="row">
            <div class="col-12">
                <h1 class="page-header">Billboard Advertisements<asp:label runat="server" ID="BillboardCodelabel"></asp:label></h1>
            </div>
        </div>
        ...
        <asp:GridView ID="GridView1" SortedAscendingHeaderStyle-CssClass="ascending" SortedDescendingHeaderStyle-CssClass="descending" runat="server" CssClass="table table-striped table-bordered table-hover"   CellPadding ="3" ForeColor="Black" GridLines="Vertical" Height="100%" Width="100%" 
            ...
            <asp:TemplateField HeaderText="Advertisement">
                ...
                <asp:BoundField DataField="ItemType" HeaderText="ItemType" SortExpression="ItemType" ItemStyle-CssClass="HideInMobile" HeaderStyle-CssClass="HideInMobile"></asp:BoundField>                               
                <asp:BoundField DataField="StartDate" HeaderText="StartDate" SortExpression="StartDate" DataFormatString="{0:D}" ItemStyle-CssClass="HideInMobile" HeaderStyle-CssClass="HideInMobile"></asp:BoundField>
                <asp:BoundField DataField="EndDate" HeaderText="EndDate" SortExpression="EndDate" DataFormatString="{0:D}" ItemStyle-CssClass="HideInMobile" HeaderStyle-CssClass="HideInMobile"></asp:BoundField>
            </Columns>
        ...
        <p>
        <asp:Label ID="ErrorMessage" runat="server" visible="false" Text="No advertisements are displayed in this billboard at the moment."></asp:Label>
        </p>
