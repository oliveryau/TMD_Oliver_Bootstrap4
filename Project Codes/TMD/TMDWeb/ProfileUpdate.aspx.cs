            ...
            else
            {
                ...
                if (pswdMatch == 1)
                {
                    if (tbPswd.Text == tbCPswd.Text)
                    {
                        ...
                        alertDangerPassword.Visible = false;
                    }
                    else
                    {
                        alertDangerPassword.Visible = true;
                        alertDanger.Visible = false;
