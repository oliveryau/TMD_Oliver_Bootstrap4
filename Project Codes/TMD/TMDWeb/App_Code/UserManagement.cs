...
namespace targeted_marketing_display
{
    public class UserManagement
    {
        ...
        public Boolean createAdmin(string Name, string Email, string ContactNumber, string Type, string PswdHash, string PswdSalt, int Status, int CreatedBy, string CreatedOn)
        {
            ...
            SqlCommand cmd = new SqlCommand("INSERT INTO [User](Name, Email, ContactNumber, Type, PasswordHash, PasswordSalt, Status, CompanyID, CreatedBy, CreatedOn) VALUES (@paraName, @paraEmail, @paraContact, @paraType, @paraPswdHash, @paraPswdSalt, @paraStatus, 7003, @paraCreatedBy, @paraCreatedOn)");
        ...
        public Boolean updateUserPassword(string Email, string uPswdHash, string uPswdSalt, string lastUpdOn)
        {
            Boolean result;

            SqlCommand cmd = new SqlCommand("UPDATE [User] SET Email = @paraEmail, PasswordHash = @paraPswdHash, PasswordSalt = @paraPswdSalt, LastUpdOn = @paraLastUpdOn WHERE Email = @paraEmail");
