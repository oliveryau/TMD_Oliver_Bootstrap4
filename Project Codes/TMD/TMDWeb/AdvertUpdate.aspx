...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <style>
        ...
        #ContentPlaceHolder1_btnBack, #ContentPlaceHolder1_btnGooo {
            width: 140px;
        }
    </style>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
        ...
        <div class="row">
            <div class="col-12">
                <asp:Button ID="btnBack" class="btn btn-primary float-left" runat="server" Text="Back" onclick="btnBack_Advert" causesValidation="false"/>

                <asp:Button ID="btnGooo" class="btn btn-primary float-right" runat="server" Text="Update" OnClick="ButtonConfirm_Click"/>
            </div>
        </div>
        <br />
        ...
        <asp:UpdatePanel ID="UpdatePanel7" runat="server" UpdateMode="Conditional">
                ...
                <div class="row">
                    <div class="col-12 col-md-6">
                        <div class="form-group">
                            <asp:label runat="server"><b>Advertisement Image/Video: </b></asp:label>
                            <br />
                            <div id="imgDiv" runat="server">
                                <asp:image id="imgLogo" runat="server" ImageUrl="" Width="200px" Height="200px" visible="true" ClientIDMode="static"></asp:image>
                            </div>
                            <div id="vidDiv" runat="server">
                                <video ClientIDMode="static" id="videoDog" width="200px" height="200px" runat="server" controls visible="true"  >  
            ...
            <Triggers>
                <asp:PostBackTrigger ControlID="btnGooo" />
            </Triggers>
        </asp:UpdatePanel>
                        ...
                        <ContentTemplate>
                            <p class="input-group">
                                ...
                                <span class="input-group-btn">
                                    <asp:LinkButton runat="server" class="btn btn-default" ID="CategoryButton" Style="height: 34px;" Text="<i class='fa fa-caret-square-o-down'></i>" OnClick="CategoryButton_Click" causesValidation="false" />
                                </span>
                            </p>
                            ...
                            <div class="modal-body">
                                ...
                                <div style="width: 100%; height: 300px; overflow: scroll">
                                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="table table-striped table-bordered table-hover" DataKeyNames="BillboardID"  
                                        AllowPaging="False" Width="100%"  BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3"  DataSourceID="SqlDataSource2">
                        ...
                        <div class="modal-dialog">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <br /><br />
                                    <p style="text-align: left">3. You cannot terminate your contract before end date.
                                    </p>
                                </div>
                                <div class="modal-footer">
