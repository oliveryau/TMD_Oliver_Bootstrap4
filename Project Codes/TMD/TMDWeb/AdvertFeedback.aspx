...
<asp:content id="Content2" contentplaceholderid="ContentPlaceHolder1" runat="server" clientidmode="Static">
    <form runat="server">
          <asp:ScriptManager ID="ScriptManager2" runat="server"></asp:ScriptManager>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <asp:Button ID="btnGen" runat="server" Text="Generate Chart" CssClass="btn btn-primary nextBtn pull-right" OnClick="btnGen_Click" />
                </div>
            </div>
                                            ...
                                            <asp:TemplateField HeaderText="Advertisement">
                                                <ItemTemplate>
                                                    <asp:Image ID="Image1" runat="server" ImageUrl='<%# Eval("Item") %>'
                                                        ...
                                                        style="display:block;object-fit: cover;" ItemStyle-HorizontalAlign="Center" />
